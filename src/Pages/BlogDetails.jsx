    ...
    const fetchComments = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/comments/${blogsDetails._id}`
        );
              ...
              <div className="flex flex-col my-4">
                <form onSubmit={handleComment} className="flex flex-col mb-10">
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder="Write your valuable comments..."></textarea>
                  <input
                    type="submit"
                    value="Send comment"
      ...
      <div className="comments w-full">
        ...
        <div className=" flex flex-col gap-4 my-3">
          {comments.map((comment) => (
            <div className=" bg-slate-200 p-4 rounded-md" key={comment._id}>
              <div className="flex gap-3 items-center">
                <img
                  className=" w-10 rounded-full"
                  src={comment.owner_prfile}
                  alt=""
                />
                <div>
